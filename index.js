...
const starSprite = textureLoader.load("./resources/textures/stars/circle.png");
const otherMap = textureLoader.load("./resources/textures/04_rainbow1k.jpg");
const colorMap = textureLoader.load("./resources/textures/00_earthmap1k.jpg");
const elevMap = textureLoader.load("./resources/textures/01_earthbump1k.jpg");
const alphaMap = textureLoader.load("./resources/textures/02_earthspec1k.jpg");
...
const uniforms = {
  ...
  colorTexture: { type: "t", value: otherMap },
  otherTexture: { type: "t", value: colorMap },
